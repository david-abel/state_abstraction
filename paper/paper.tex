...
{\bf Proof:}
Given the ground \ac{MDP}, $M_G$, consider the \ac{MDP}, $M_G'$ which is identical to $M_G$ except in its transition and rewards.
...
Where
\begin{align}
\mathcal{R}_G'(s,a) = R_A(\epM(s), a)\\
\mathcal{T}_G'(s,a, s') = R_A(\epM(s), a, \epM(s'))
\end{align}

We know by \cite{li2006towards} that .

...
\newcommand{\epQ}{\ep_{Q^*,\varepsilon}}
\newcommand{\epB}{\ep_{\text{bolt},\varepsilon}}
\newcommand{\epMu}{\ep_{\text{mult},\varepsilon}}
\newcommand{\epM}{\ep_{\text{model},\varepsilon}}
...
% Paper Meta Info
\icmlauthor{David Abel$^\dagger$}{david\_abel@brown.edu}
%\icmladdress{Brown University, 115 Waterman Street, Providence, RI 02906}
\icmlauthor{D. Ellis Hershkowitz$^\dagger$}{david\_hershkowitz@brown.edu}
%\icmladdress{Brown University, 115 Waterman Street, Providence, RI 02906}

...
We ran experiments on aggregation functions in the $\epQ$ family of approximate abstractions.  \dnote{Some explanation of why we didn't do all 4 abstractions}
...
\caption{$\epsilon$ vs. Num States and $\epsilon$ vs. Abstract Policy Value\label{fig:main_empirical_results1}}
\end{figure*} 

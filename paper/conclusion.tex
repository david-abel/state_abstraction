...
First, we are interested in extending the approach of \citeauthor{ortner2013adaptive} by learning the approximate abstraction functions introduced in this paper online in the planning or \ac{RL} setting. \dnote{Add year if possible}

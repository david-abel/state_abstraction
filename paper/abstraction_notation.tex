...
% Reward
\bdefn{$\mcR_A$}
The abstract reward function $\mathcal{R}_A: \mathcal{S}_A \times \mathcal{A} \mapsto [0,1]$ is a weighted sum of the rewards of each of the ground states that map to the same abstract state:
\begin{equation}

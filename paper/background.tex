...
\end{equation}
Lastly, we denote the value and $Q$ functions under the optimal policy as $V^*$ and $Q^*$, respectively. For further background, see~\cite{kaelbling1996reinforcement}.

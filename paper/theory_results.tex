...
% Q* Lemma -- lemma 1
We consider an approximate version of \citeauthor{li2006towards}'s $\phi_Q^*$, where states are aggregated together when their optimal $Q$-values are within $\epsilon$.
...
Now, consider an approximate version of \citeauthor{li2006towards}'s $\phi_{model}$, where states are aggregated together when their rewards and transitions are within $\epsilon$.
\bdefn{$\epM$}

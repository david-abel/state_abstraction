...
% By bounds imposed from epsilon_2 on our sums of k_i's
...
\begin{align*}
-\epsilon*(D' + 2\varepsilon_2) - k_1 + k_2 &\leq -A + Q_1 - Q_2 \leq \epsilon*(D' + 2\varepsilon_2) - k_1 + k_2 \\
-\epsilon*(D' + 2\varepsilon_2) - k_1 + k_2 + A &\leq + Q_1 - Q_2 \leq \epsilon*(D' + 2\varepsilon_2) - k_1 + k_2 + A \\
\end{align*}

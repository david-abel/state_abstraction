...
\begin{enumerate}
\item \textsc{Compressibility}: To compress $M_G$ to be significantly smaller \dnote{requires further info}. In general, \acp{MDP} of interest that are intractable are typically made so in virtue of the size of their state space, not the size of the action space or transition model.

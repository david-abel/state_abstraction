...
\thm{Lemma}{1}{(Simulation Lemma)}

\thm{Lemma}{2}{Under the model approximate abstraction scheme, an the Q values for the ground MDP will be within $\epsilon$ of the abstract MDP under an arbitrary policy.}
